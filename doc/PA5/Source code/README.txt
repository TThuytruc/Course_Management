...
# Tổng quan:
- Hệ thống chạy trên nền tảng web (sử dụng tốt nhất trên trình duyệt Google Chrome).
...
Mật khẩu được cấp sẵn ban đầu đều là "123", sau khi đăng nhập người dùng có thể 
thực hiện chức năng đổi mật khẩu. 3 tài khoản mẫu:
